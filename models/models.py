...
class SuperCauchosVentas(models.Model):
    ...
    estado = fields.Selection(selection=[('activo', 'Activo'), ('inactivo', 'Inactivo'), ('transito', 'En transito')])

    imagen = fields.Binary()

    titulo_producto = fields.Char('Titulo del reporte')

class ProductosDisponibles(models.Model):

    _inherit = 'ventas.disp'

    def _ProductosDisponibles():
